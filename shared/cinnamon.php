...
$page_title = 'Ceylon Cinnamon';
$category_type = 'cinnamon';

// Fetch products with category "Utilized" and filter by cinnamon-related names
$sql = "SELECT p.*, s.seller_name 
        FROM products p 
        JOIN sellers s ON p.seller_id = s.seller_id 
        WHERE p.category = 'Utilized' 
        AND (LOWER(p.name) LIKE '%cinnamon%' OR LOWER(p.name) LIKE '%spice%' OR LOWER(p.name) LIKE '%bark%')
...
<head>
  ...
  <meta name="description" content="Discover authentic Ceylon Cinnamon products from Sri Lankan farmers">
  <meta name="keywords" content="cinnamon, ceylon cinnamon, spices, sri lanka, authentic">
  ...
  <main class="main">
    ...
    <div class="page-title dark-background">
      <div class="container position-relative">
        ...
        <p>
          Discover the finest Ceylon Cinnamon, renowned worldwide for its delicate flavor and aromatic qualities. Our authentic Sri Lankan cinnamon products are sourced directly from local farmers committed to traditional cultivation methods.
        </p>
        ...
        <div class="row gy-5">
                      ...
                      elseif (preg_match('/\.(mp4|webm|ogg|avi|mov)$/i', $video_url) || 
                          ...
                          if (strpos($video_url, '../') !== 0 && strpos($video_url, 'http') !== 0) {
                              ...
                              if (strpos($video_url, 'assets/') === 0) {
                                  ...
                                  // Default to cinnamon category folder for local files
                                  $video_url = '../assets/videos/products/utilized/cinnamon/' . basename($video_url);
                              }
                          }
                      }
          ...
          <div class="col-12 text-center">
            <div class="no-products">
              <h3>No Cinnamon Products Available</h3>
              <p>We're currently updating our cinnamon inventory. Please check back soon for authentic Ceylon Cinnamon products!</p>
